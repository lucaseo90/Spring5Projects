...
export default class CountryLanguage extends mixins(AlertMixin) {
  ...
  public mounted(): void {
    this.retrieveAllCountryLanguages();
  }
  ...
  public retrieveAllCountryLanguages(): void {
  ...
  public prepareRemove(instance: ICountryLanguage): void {
  ...
  public removeCountryLanguage(): void {
    this.countryLanguageService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('worldgdpApp.countryLanguage.deleted', { param: this.removeId });
